...
│   │   ├── __darwin/                      # darwin config specific for users
│   │   └── __nixos/                       # nixos config specific for users
...
│   │   ├── __darwin/                      # darwin config specific for hosts
│   │   └── __nixos/                       # nixos config specific for hosts
...
│   └── secrets.yaml                       # secrets for hosts
